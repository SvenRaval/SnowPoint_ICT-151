...
function ArticleAddItem($addItem)
{
    ...
    if (isset($addItem['InputArticleCode']) && isset($addItem['InputMarque']) && isset($addItem['InputModele']) && isset($addItem['InputDescription']) && isset($addItem['InputLongeur']) && isset($addItem['InputNiveau']) && isset($addItem['InputPrix']) && isset($addItem['InputQty']) && isset($addItem['InputDescComp']) && isset($addItem['radioGenre'])) {
