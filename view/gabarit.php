				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li>
								<a href="view/content/product.html">Shop</a>
							</li>

							<li class="sale-noti">
								<a href="view/content/product.html">Sale</a>
							</li>
						...
						<div class="header-cart header-dropdown">
							...
							<div class="header-cart-buttons">
								<div class="header-cart-wrapbtn">
									<!-- Button -->
									<a href="view/content/cart.html" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
										View Cart
									</a>
								</div>
