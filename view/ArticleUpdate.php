    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 p-b-30">
                <form class="leave-comment" action="index.php?action=ArticleUpdateItem" method="post">
                    ...
                    <div class="bo4 of-hidden size15 m-b-20">
                        <input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="InputArticleCode"
                               placeholder="Code de l'article" value="<?= @$_POST['InputArticleCode'] ?>" disabled="disabled">
                    </div>
                    <div class="bo4 of-hidden size15 m-b-20">
