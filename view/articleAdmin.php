                                ...
                                <div class="wrap-table-shopping-cart bgwhite">
                                    <table id="cart" class="table-shopping-cart">
                                        <tr class="table-head">
                                            ...
                                            <th class="column-2"><a href="index.php?action=ArticleAddItem">
                                        ...
                                        <?php foreach ($articles as $article) : ?>
                                            ...
                                            <tr id="B101" class="table-row">
                                                    ...
                                                    <div class="cart-img-product b-rad-4 o-f-hidden">
                                                        ...
                                                        <?php else : ?>
                                                            <img src="view/content/images/no_image_snow_small.png"
                                                                 alt="no image" alt="IMG-PRODUCT-NO-IMAGE">
                                                        <?php endif; ?>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="column-2">
                                                    <a <?= $_SESSION['codeDelete'] = $article['code'] ?>
                                                            href="index.php?action=articleRemoveItemCode"
                                                            class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">
                                                        <img src="view/content/images/icons/bin2.png" alt="delete">
                                                        </button></a><br>
                                                    <a <?= $_SESSION['codeUpdate'] = $article['code']?>
                                                            href="index.php?action=articleUpdateItem">
